...
- Added more thorough customization options 
- Made some miscellaneous formatting/consistency fixes

# 1.0.1
- Geode compatibility fixes
- Fixed "Disable in practice mode" not disabling the endscreen sound
